...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                ...
                <button id="create-order-btn" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 flex items-center space-x-2">
    ...
    <!-- Create Order Modal -->
    <div id="create-order-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            ...
            <form id="create-order-form" class="space-y-4" method="post" action="">
                ...
                <div class="flex space-x-2">
                    <button type="submit" name="submit" value="command" class="flex-1 px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                        Create Order
                    </button>
    ...
    <!-- Edit Order Modal -->
    <div id="edit-order-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="flex justify-between items-center mb-4">
            ...
            <form id="edit-order-form" class="space-y-4" method="post" action="">
                ...
                <div class="flex space-x-2">
                    ...
                    <button type="button" id="cancel-edit-modal" class="flex-1 px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">
                        Cancel
                    </button>
                </div>
            </form>
